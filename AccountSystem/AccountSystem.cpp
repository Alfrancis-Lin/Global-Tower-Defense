...
class AccountManager {
  ...
  public:
    ...
    virtual bool createAccount(const std::string &name, const std::string &pass,
...
class OfflineAccount : public AccountManager {
    private:
        std::string getFilePath(const std::string& name) { return save_dir + name + ".json"; }

    public:
        bool createAccount(const std::string& name, const std::string& pass, const std::string& email) override
        {
        ...
        bool login(const std::string& name, const std::string& pass) override {
            ...
            if (storedHash != hashPassword(pass)) return false;
