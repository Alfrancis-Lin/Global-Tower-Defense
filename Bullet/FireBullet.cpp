...
FireBullet::FireBullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Turret *parent) : Bullet("play/bullet-1.png", 500, 0.5, position, forwardDirection, rotation - ALLEGRO_PI / 2, parent) {
}
