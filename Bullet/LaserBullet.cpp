...
LaserBullet::LaserBullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Turret *parent) : Bullet("play/laser0610.png", 1000, 0.5, position, forwardDirection, rotation - ALLEGRO_PI / 2, parent) {
}
