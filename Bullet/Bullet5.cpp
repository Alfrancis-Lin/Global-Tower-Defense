...
Bullet5::Bullet5(Engine::Point position, Engine::Point forwardDirection, float rotation, Turret *parent) : Bullet("play/bullet-5.png", 500, 2, position, forwardDirection, rotation - ALLEGRO_PI / 2, parent) {
}
